	...
	<section class="most_popular_item_area menu_list_page">
		<div class="container">
			<div class="popular_filter">
				<ul>
					<li class="active" data-filter="*"><a href="">좋아요 누른 음식</a></li>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									&nbsp; <a href="javascript:void(0)" class="read_mor_btn"
										onclick="mapView('${fn:trim(dto.fname)}');">주변음식점</a> &nbsp; <a
										href="javascript:void(0)" class="read_mor_btn"
										onclick="location.href='cook.do?cd=detail&fno=${dto.fno}'">레시피보기</a>
									<ul>
										<li><i class="fa fa-heart" onclick="popularity(this,${dto.fno});"></i></li>
									</ul>
								</div>
							</div>
						</div>
